...
export default function SignupPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!ageCheck) {
            return setError('You must be 18+ to join');
        }
        ...
        try {
            ...
            if (!res.ok) {
                setError(data.error === 'email_taken' ? 'Email already in use' :
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between mt-10 gap-6">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full md:w-auto bg-[#B03EE1] text-white rounded-full px-16 py-3.5 font-bold text-base hover:bg-[#c04ef1] transition-all active:scale-95 shadow-[0_0_20px_rgba(176,62,225,0.3)] flex items-center justify-center gap-2"
                        >
